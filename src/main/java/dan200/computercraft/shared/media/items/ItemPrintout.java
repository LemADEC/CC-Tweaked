...
public class ItemPrintout extends Item
{
    ...
    @Override
    public void buildTooltip( @Nonnull ItemStack stack, World world, List<TextComponent> list, TooltipOptions options )
    {
    ...
    public static String getTitle( @Nonnull ItemStack stack )
    {
        ...
        return nbt != null && nbt.containsKey( TAG_TITLE ) ? nbt.getString( TAG_TITLE ) : null;
    }

    public static int getPageCount( @Nonnull ItemStack stack )
    {
        CompoundTag nbt = stack.getTag();
        return nbt != null && nbt.containsKey( TAG_PAGES ) ? nbt.getInt( TAG_PAGES ) : 1;
    }
