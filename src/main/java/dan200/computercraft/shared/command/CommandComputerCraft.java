...
import net.minecraft.client.network.packet.PlayerPositionLookClientPacket.Flag;
            ...
            .then( command( "tp", "Teleport to a specific computer." )
                ...
                .executes( context -> {
                    ...
                    if( entity instanceof ServerPlayerEntity )
                    {
                        ...
                        {
                            player.networkHandler.method_14360( pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5, 0, 0, EnumSet.noneOf( Flag.class ) );
                        }
                        else
                        {
