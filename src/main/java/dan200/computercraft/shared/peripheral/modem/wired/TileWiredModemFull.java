...
public class TileWiredModemFull extends TileGeneric implements Tickable, IPeripheralTile
{
    ...
    public TileWiredModemFull( BlockEntityType<? extends TileWiredModemFull> factory )
    {
        super( factory );
